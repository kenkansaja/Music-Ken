...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "gcsupportbots")
PROJECT_NAME = getenv("PROJECT_NAME", "𝙈𝙐𝙎𝙄𝘾 𝙈𝘼𝙉")
OWNER = getenv("OWNER", "@kenkanasw")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/kenkannih/Music-Ken")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "30"))
ARQ_API_KEY = getenv("ARQ_API_KEY", None)
PMPERMIT = getenv("PMPERMIT", None)
LOG_GRP = getenv("LOG_GRP", None)
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ !").split())
START_FOTO = getenv("START_FOTO", "https://telegra.ph/file/c8227ff23fa75b9d2b9f7.jpg")
