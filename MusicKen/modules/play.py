...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text((20, 550), f"Title: {title}", (51, 215, 255), font=font)
    draw.text((20, 590), f"Duration: {duration}", (255, 255, 255), font=font)
    draw.text((20, 630), f"Views: {views}", (255, 255, 255), font=font)
    draw.text((20, 670), f"Added By: {requested_by}", (255, 255, 255), font=font,)
    img.save("final.png")
    os.remove("temp.png")
